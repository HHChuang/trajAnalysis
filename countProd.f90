...
!   assign the product name by the user-define criteria.    !
!                                                           !
! Input :                                                   !
...
!                                                           !
! 2018/11/30, Grace                                         !
! 2018/12/04, Grace, separate the trajectory to 2 directions!
...
Program main 
    ...
    ! Step 2. Assign the product as P1 or P2
        call print_NumProd(NAtoms,coord1)
        call print_NumProd(NAtoms,coord2)
stop
end program main
...
subroutine print_NumProd(NAtoms,coord)
    implicit none
    ...
    write(*,'(A)',advance='no') 'This last point of one direction is: '
    if ( NumProd0 ) then
        write(*,'(A)') 'R'
        ...
        write(*,'(A)' ) 'none of them'
    end if
    return
end subroutine print_NumProd
